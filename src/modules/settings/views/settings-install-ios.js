import{ICONS}from'../../../core/theme/icons.js';import{i18nService}from'../../../core/i18n/i18n.service.js';export class SettingsInstallIos extends HTMLElement{constructor(){super();this.dict=null;}
async connectedCallback(){this.dict=await i18nService.loadPage('settings/install-ios');this.render();this.addListeners();}
render(){if(!this.dict)return;this.innerHTML=`
        ...
        `;}
addListeners(){this.querySelector('#btn-back').addEventListener('click',()=>window.history.back());}}
