import{router}from'../../../core/router/index.js';import{i18nService}from'../../../core/i18n/i18n.service.js';import'../../system/components/btn.js';import'../../system/components/navbar.js';export class AnalysisDashboard extends HTMLElement{constructor(){super();}
async connectedCallback(){this.i18n=await i18nService.loadPage('training_analysis/analysis-dashboard');this.render();this._attachListeners();}
render(){const infoIcon=`
    ...
    <app-btn id="btn-analyze" label="${this.i18n.t('dash_btn_analyze')}" variant="primary"></app-btn>
        ...
        `;}
_attachListeners(){const btnAnalyze=this.querySelector('#btn-analyze');btnAnalyze.addEventListener('click',()=>{router.navigate('/training/analysis/results');});}}
