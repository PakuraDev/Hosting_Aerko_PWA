import{ICONS}from'../../../core/theme/icons.js';import{i18nService}from'../../../core/i18n/i18n.service.js';export class AppRoutineRow extends HTMLElement{static get observedAttributes(){return['name'];}
constructor(){super();}
async connectedCallback(){const dict=await i18nService.loadPage('training_flow/routine-row');this.t=dict.t;this.render();}
attributeChangedCallback(name,oldValue,newValue){if(oldValue!==newValue&&this.t){this.render();}}
render(){if(!this.t)return;const name=this.getAttribute('name')||this.t('row_fallback_name');this.innerHTML=`
            <style>
